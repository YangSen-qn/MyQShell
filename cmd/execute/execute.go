...
type IExecute interface {
	...
	Check(context *common.QShellContext) qn_error.IError
	Prepare(context *common.QShellContext) qn_error.IError
	Execute(context *common.QShellContext) qn_error.IError
}
